...
const items = [
{
  key: '1',
  artist: 4,
  image: 'https://wallpapers.com/images/hd/ben-10-alien-force-still-26p3m5it74lcu3k5.jpg',
  price: '3.8',
  title: 'Ben 10 NFT Collection',
  timeLeft: 84670923 },

{
  key: '2',
  artist: 2,
  image: 'https://oyster.ignimgs.com/mediawiki/apis.ign.com/pokemon-sun-pokemon-moon/6/6d/Partnercappikachu.jpg?width=640',
  price: '2.5',
...

{
  key: '3',
  artist: 0,
  image: 'https://m.media-amazon.com/images/I/6123No2dRdL._AC_UF1000,1000_QL80_.jpg',
  price: '9.0',
  title: 'Beyblade NFT Collection',
  timeLeft: 84720185 },

{
  key: '4',
  artist: 3,
  image: 'https://www.looper.com/img/gallery/25-most-powerful-naruto-characters-ranked-worst-to-best/intro-1651164487.jpg',
  price: '16.5',
  title: 'Naruto NFT Collection',
  timeLeft: 43826185 },

{
  key: '5',
  artist: 2,
  image: 'https://static1.thegamerimages.com/wordpress/wp-content/uploads/2019/09/MHA-Feature.jpg',
  price: '4.0',
  title: 'MHA NFT Collection',
  timeLeft: 134627 },

{
  key: '6',
  artist: 1,
  image: 'https://w0.peakpx.com/wallpaper/43/891/HD-wallpaper-sukuna-yuji-itadori-jujutsu-kaisen.jpg',
  price: '1.3',
  title: 'Jujutsu Kaisen NFT Collection',
  timeLeft: 12008745 }];
...
const artists = [
{
  name: 'Sonali',
  handler: '@sonali',
  image: 'https://wallpapers.com/images/hd/anime-symbols-neon-red-geass-code-geass-7el38ooj0jculgyh.jpg' },
...
function SidebarRight() {
  return /*#__PURE__*/(
    ...
    React.createElement("h2", { className: "text-xl font-semibold" }, "Community Owners"), /*#__PURE__*/
    ...
    React.createElement("h2", { className: "text-white font-semibold" }, "Secure Communication between NFT Communities"), /*#__PURE__*/


    React.createElement("p", { className: "text-white/50 text-sm mt-1 " }, "When you buy NFTs you become a part of that Collection's particular chatroom(only nft holders can access those chats)"), /*#__PURE__*/


    React.createElement("button", { className: "bg-white w-full rounded-md h-12 text-gray-900 font-semibold mt-2" }, "Learn more")), /*#__PURE__*/
...
function Items() {
  return /*#__PURE__*/(
    ...
    React.createElement("h3", { className: "font-semibold" }, "NFT Price"), /*#__PURE__*/
    React.createElement("div", { className: "" }, price, " ETH")), /*#__PURE__*/

    React.createElement("div", { className: "w-1/2 p-3" }, /*#__PURE__*/
    React.createElement("h3", { className: "font-semibold" }, "Enrollment closing in"), /*#__PURE__*/
    ...
    React.createElement("button", { className: "bg-gradient-to-tr from-fuchsia-600 to-violet-600  w-full h-12 rounded-md font-semibold" }, "Buy and join community")), /*#__PURE__*/
    ...
    React.createElement("div", { className: "bg-zinc-800 w-full h-full rounded-md grid place-items-center" }, "Details")))))))));
...
function Content() {
  return /*#__PURE__*/(
    ...
    React.createElement("h2", { className: "text-zinc-500 px-3" }, "Buy NFT collections and become a part of the communities"), /*#__PURE__*/
    ...
    React.createElement("h2", { className: "font-bold text-3xl max-w-sm" }, "Introducing NFT Collection Chat Rooms"), /*#__PURE__*/
    ...
    React.createElement("h2", { className: "text-xl font-semibold" }, "Trending NFT Communities"), /*#__PURE__*/
    React.createElement("ul", { className: "inline-flex space-x-3 " },
    ['1', '2', '3', '4'].map((text, index) => /*#__PURE__*/
...
function Header() {
  return /*#__PURE__*/(
    ...
    React.createElement("div", { className: "w-10 h-10 bg-gradient-to-tr from-fuchsia-600 to-violet-600 grid place-items-center rounded-full font-bold text-white  text-2xl" }, "~"), /*#__PURE__*/



    React.createElement("div", { className: "ml-2 font-bold text-xl" }, "Alcatraz")), /*#__PURE__*/
    ...
    React.createElement("img", {
      src: "https://wallpapers.com/images/hd/anime-symbols-neon-red-geass-code-geass-7el38ooj0jculgyh.jpg",
      alt: "user",
